 ...
 *
 * Ваша задача: с помощью extends и with добиться того, чтобы вызов o.str возвращал слово YDOCHKA
 *  Раскоментируйте тест trait_linearization_test и проверьте результат
